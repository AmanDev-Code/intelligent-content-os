        ...
        <div className="space-y-10 text-sm leading-7 text-foreground/90">
          <section className="space-y-3">
            ...
            <p>
              ...
              Trndinn feature, you agree to these Terms. If you do not agree, you must not use the service.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Trndinn is an AI-assisted content operations platform designed to help users discover topics,
          ...
          <section className="space-y-3">
            ...
            <p>You may use Trndinn only for lawful, authorized, and legitimate business or creator purposes.</p>
            <ul className="list-disc space-y-2 pl-6">
          ...
          <section className="space-y-3">
            ...
            <p>
              You are responsible for ensuring that your use of Trndinn complies with the laws, platform policies,
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              Trndinn does not guarantee that any generated output is correct, compliant, original, non-infringing,
          ...
          <section className="space-y-3">
            ...
            <p>
              By connecting LinkedIn or any other platform, you authorize Trndinn to act within the permissions granted
          ...
          <section className="space-y-3">
            ...
            <p>
              We retain all rights in the Trndinn service, software, design, branding, documentation, and related
          ...
          <section className="space-y-3 border-t pt-8">
            ...
            <p>
              For legal, compliance, or platform-governance matters related to Trndinn, please contact the operator
