          ...
          {!isGenerating && isFailed && jobId && (
            <div className="space-y-3 animate-fade-in">
              ...
              <Button
                onClick={handleRetry}
                disabled={isGenerating}
                className="w-full gradient-primary text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] h-11 hover:opacity-95"
              >
