...
const useItems = [
  ...
  "To generate, improve, schedule, publish, and manage AI-assisted content workflows inside Trndinn.",
      ...
      <div className="mx-auto max-w-5xl px-6 py-12 md:px-8">
        ...
        <div className="space-y-10 text-sm leading-7 text-foreground/90">
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold">1. What Trndinn Is Made For</h2>
            <p>
              Trndinn is built to help individuals, teams, brands, creators, and businesses discover topics,
          ...
          <section className="space-y-3">
            ...
            <p>
              When you connect a third-party service such as LinkedIn, you authorize Trndinn to access and process
          ...
          <section className="space-y-3">
            ...
            <p>
              Trndinn is designed with privacy, platform integrity, content governance, and security obligations in mind.
          ...
          <section className="space-y-3">
            ...
            <p>
              Trndinn is not intended for children and should be used only by persons legally permitted to enter into
          ...
          <section className="space-y-3 border-t pt-8">
            ...
            <p>
              For privacy, compliance, or security inquiries relating to Trndinn, please contact the service operator
