...
export const FALLBACK_PRICING_META: PricingMeta = {
  ...
  faqs: [
    { q: "What does agentic mean on Trndinn?", a: "Agentic means AI that completes multi-step workflows — draft, schedule, publish, distribute — with minimal UI friction. Today: in-app Agent, Brand Kit, calendar, Public API v1, webhooks, and Content Engine. MCP and CLI for external agents are on the roadmap." },
    { q: "How do credits work?", a: "Credits power agent actions like generating, scheduling, publishing, and distributing. Each plan includes a monthly allotment; you can use credits on any action until your balance runs out." },
    ...
    { q: "Can I connect Claude or ChatGPT today?", a: "Use Public API v1 and signed webhooks on Team and Agency plans to wire Trndinn into your stack. MCP server and CLI for Claude, ChatGPT, and Cursor are coming soon." },
    { q: "Which platforms are supported?", a: "LinkedIn is live today (personal profiles and Company Pages). Other channels are on the roadmap. You publish only to accounts you connect." },
  ],
  plans: [
