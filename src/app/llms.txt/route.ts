...
function buildLlmsTxt(base: string): string {
  const lines = [
    ...
    `- Instagram Reel Downloader (free tool): ${base}/tools/instagram-reel-downloader`,
    ...
    `- Instagram Reel Downloader (primary): ${base}/tools/instagram-reel-downloader — download any public Instagram Reel as MP4 in HD quality, no watermark, no signup. Works on any device (iPhone, Android, PC, Mac). Personal, non-commercial use only.`,
    ...
    "- Roadmap tools (not yet live): Instagram Caption Generator, LinkedIn Post Generator, LinkedIn Hook Generator, Hashtag Generator.",
    "",
