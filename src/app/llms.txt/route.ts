...
function buildLlmsTxt(base: string): string {
  const lines = [
    ...
    `- Instagram Reel Downloader: ${base}/tools/instagram-reel-downloader — download any public Instagram Reel as MP4 in HD quality, no watermark, no signup. Works on any device (iPhone, Android, PC, Mac). Personal, non-commercial use only.`,
