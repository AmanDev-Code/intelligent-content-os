...
function buildLlmsTxt(base: string): string {
  const lines = [
    ...
    "- Does: AI-assisted content creation, scheduling, calendars, analytics, and multi-channel publishing workflows for authenticated subscribers.",
    "- Does not: Operate as a generic LLM API for unauthenticated crawl-driven queries; pricing and plan limits may change; checkout and receipts are handled by Paddle as merchant of record.",
    "",
